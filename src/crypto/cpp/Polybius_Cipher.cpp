...
std::string polybius_cipher::get_key() const {
    return "keyword=" + keyword;
};
     
bool polybius_cipher::set_key(const std::string& key_str) {
 ...
 polybius_cipher::polybius_cipher(const std::string& key ) {
    if (key.empty()) {
...
std::string polybius_cipher::encode(const std::string message)  {
...
std::string polybius_cipher::decode(const std::string message)  {
...
std::pair<std::string, std::string> polybius_cipher::encode_with_key(const std::string message) {
...
std::pair<std::string, std::string> polybius_cipher::decode_with_key(const std::string message, const std::string key_str) {
